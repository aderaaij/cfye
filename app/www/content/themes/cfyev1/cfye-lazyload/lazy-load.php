 ...
 * Description: Lazy load images to improve page load times. Adapted to use a document.scroll function to only load an imag when it's visibl in the viewport. 
 * Replaced this Uses jQuery.sonar to only load an image when it's visible in the viewport.
 * Version: 0.5
 *
