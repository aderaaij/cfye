...
//Global functions
(function ($) {
    //clicktoggle function (.toggle deprecated since jQuery 1.9.1)
    ...
    } // end function singleSlideshow()

    /* Call thumbimags */
    thumbImageCall = function () {
        if ($('.top-content-wrap').exists()) {           
            $('.top-content-wrap').waitForImages(function() {
   ...
   $(this).addClass('loaded');
           ...
           /* var images = $('img');
            ...
            images.imagesLoaded(singleSlideshow, $('.preloader').hide());*/
        }
    }; // end slideShowCall();
...
(function ($) {
    ...
    $(window).load(function () {
        ...
        $('.entry-content').imagesLoaded(resizePostImg);
    });
}(jQuery));
...
(function ($) {
   ...
   $(this).addClass('loaded');
    ...
    $(window).on('statechangecomplete', function () {
        ...
        $('.carousel-wrap').append('<div class="preloader"></div>');
        $('.top-content-wrap').append('<div class="img-preloader"></div>');
        $('.big-wrap').imagesLoaded(wrapImages);
        $('.single-video-wrap').append('<div class="preloader"></div>');
